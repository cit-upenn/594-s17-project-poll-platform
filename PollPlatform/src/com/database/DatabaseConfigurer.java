...
public class DatabaseConfigurer {
	...
	public static final String JDBC_URL = "jdbc:derby:/Users/apple/Documents/workspace/Java/PollPlatform/myDatabase;create=true";
	...
	private static void createConnection() throws ClassNotFoundException {
		...
		//run these statements when you want to drop the existing tables
//		jdbcTemplate.execute("DROP TABLE poll");
//		jdbcTemplate.execute("DROP TABLE pollUser");
//		jdbcTemplate.execute("DROP TABLE filledPolls");

		//run these statements when creating the database for the first time
